...
public abstract class ArmBaseCommand extends LoggingCommand {
    ...
    private double calcAimHold(double aimAngle, double linkAngle) {
         ...
         * Link = 90 and Aim = 180 - link and aim parallel to the floor - max torque on the link joint
         * Link = 90 and Aim = 270 - link parallel to the floor - aim straight up - no torque on the aim joint
         * (note this is not a valid arm position ^^^)
         *
         * Link = 180 and Aim = 90 - link straight up, aim paralled to the floor - max torque on the aim joint
         *
         */
    ...
    private double calcLinkHold(double aimAngle, double linkAngle) {
         ...
         *
         * Link = 90 - link parallel to the floor: Aim = 180 - also parallel to the floor = max torque on the link joint
         */
