...
public class Score1SpeakerAutoCommand extends SequentialCommandGroup {
    ...
    public Score1SpeakerAutoCommand(SwerveSubsystem swerve, ArmSubsystem arm, JackmanVisionSubsystem jackman, LightingSubsystem lighting, double delay) {
        ...
        addCommands(new DriveToNoteCommand(swerve, lighting, arm, jackman, 1)
                .alongWith(new StartIntakeCommand(arm, lighting)));
