...
import static frc.robot.Constants.BotTarget.BLUE_AMP;
...
public class PlanBAutoCommand extends SequentialCommandGroup {
    ...
    public PlanBAutoCommand(SwerveSubsystem swerve, HughVisionSubsystem hugh) {
        ...
        //TODO: configure starting pose translation
        Pose2d blueStartPose = new Pose2d(new Translation2d(), Rotation2d.fromDegrees(270));
        Pose2d redStartPose = new Pose2d(new Translation2d(), Rotation2d.fromDegrees(270));
