...
import static frc.robot.telemetry.Swerve.Implementation.RUNNYMEDE;
...
public class Swerve {
    ...
    public static Map<String, Swerve.ModuleTelemetry> modules               = new LinkedHashMap<>();

    public Swerve.ModuleTelemetry getModule(String name) {
        if (!modules.containsKey(name)) {
            modules.put(name, new Swerve.ModuleTelemetry());
        }
    ...
    public void post() {
        ...
        if (implementation == RUNNYMEDE) {
            ...
            for (String name : modules.keySet()) {
                Swerve.ModuleTelemetry module = modules.get(name);
