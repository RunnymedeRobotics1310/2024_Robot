...
public class OperatorInput extends SubsystemBase {
    ...
    public void configureButtonBindings(ArmSubsystem armSubsystem,
        JackmanVisionSubsystem visionSubsystem, OperatorInput operatorInput, ClimbSubsystem climbSubsystem) {
        ...
        new Trigger(() -> isCancelPressed())
            .onTrue(new CancelCommand(operatorInput, armSubsystem, climbSubsystem));
